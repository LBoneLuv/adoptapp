...
export function AppHeader() {
  ...
  const getPageTitle = () => {
    ...
    if (pathname?.startsWith("/tienda/pedido-ok")) return "Pedido confirmado"
    if (pathname?.startsWith("/tienda/checkout")) return "Finalizar compra"
    ...
    if (pathname?.startsWith("/comunidad/nuevo")) return "Nuevo hilo"
    if (pathname?.startsWith("/comunidad/mis-hilos")) return "Mis hilos"
    if (pathname?.startsWith("/comunidad/hilo")) return "Hilo"
